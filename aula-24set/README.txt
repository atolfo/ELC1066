* DESCRIÇÃO
Este exercício consiste na implementação das funções pilha_cria(),
pilha_empilha() e pilha_desempilha()  utilizando lista encadeada para a
estrutura de dados TAD pilha_t - pilha.

O exercício consiste em 
- implementar a função pilha_cria() no arquivo pilha.c com lista
- implementar a função pilha_empilha() no arquivo pilha.c com lista
- implementar a função pilha_desempilha() no arquivo pilha.c lista 
...
gcc -Wall -g -o principal principal.c pilha.c -lm
